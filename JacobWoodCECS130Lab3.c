...
quotient, take a dividend and divisor and return a remainder through the modulus function, and
take a number and determine whether it is prime or not.  The calculator will run repeatedly until
the user wishes to exit.
*/
int selection, prime_init, prime_input, isprime, mod_num1, mod_num2, divis_by;
//initializes integers used in later functions
float addend1, addend2, minuend, subtrahend, multiplicand, multiplier, dividend, divisor;
